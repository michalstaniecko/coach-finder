...
const userIsCoach = computed(() => id === userStore.getCurrentUserId);
</script>
  ...
  <li>
    <base-box>
      ...
      <div class="buttons is-justify-content-flex-end">
        <base-button :disabled="userIsCoach" link :to="contactLink" class="is-outlined is-small">Contact</base-button>
